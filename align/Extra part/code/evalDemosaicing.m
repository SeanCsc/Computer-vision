...
dataDir = fullfile('EECS442','hw1-finish','Extra part','data','demosaic');

% Path to your output directory
outDir = fullfile('EECS442','hw1-finish','Extra part','output','demosaic');
...
fprintf('# \t image \t\t baseline \t nn \t\t linear \t adagrad \t trans\n'); 
fprintf([repmat('-',[1 100]),'\n']); 
for i = 1:numImages,
